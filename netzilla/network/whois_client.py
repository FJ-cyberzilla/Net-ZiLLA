"""
Module for retrieving domain WHOIS information.
"""
...
from netzilla.interfaces import DomainInfo, WHOISClient
...
class WhoisClient(WHOISClient):
    ...
    async def lookup(self, domain: str) -> DomainInfo:
        ...
        return DomainInfo(
            ...
            is_newly_registered=(now - created).days < 30 if created else False,
